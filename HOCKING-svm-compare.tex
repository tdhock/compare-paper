...
model with the maximum AUC on the validation set.  For all kernels, the grid of cost parameters was $C=10^{-20},10^{18}, \dots,10^0$. For the gaussian kernel $\sigma = 10^{-1},10^{0},10^1$ and for the polynomial kernel degree $=1,2, \dots,3$.  We then used the selected hyper-parameters to train a
