...
\begin{equation}
  ...
  \right]/\beta,
\end{equation}
where the optimal primal variables $\alpha_i=-\tilde y_i v_i$ and
$\alpha_i'=\tilde y_i v_i$ for all $i\in\{1,\dots,m\}$. The learned
comparison function remains the same (\ref{eq:kernelized_c}).
